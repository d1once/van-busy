      ...
      {bookings.length > 0 && (
        <div className="bookings-list">
          {bookings.map((booking) => {
            ...
            const totalPrice = destination?.price ? destination.price * numberOfSeats : 'N/A';
            ...
            return (
              <div key={booking._id} className="booking-card">
                ...
                <div className="booking-card-body">
                  <p><strong>Minibus:</strong> {minibus ? minibus.name : 'N/A'} ({minibus ? minibus.licensePlate : 'N/A'})</p>
