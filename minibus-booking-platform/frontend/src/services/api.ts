...
export interface BookingResponse { // Assuming backend returns the created booking
  _id: string;
...
export const createBooking = async (bookingData: BookingPayload): Promise<{ message: string, booking: BookingResponse }> => {
  try {
